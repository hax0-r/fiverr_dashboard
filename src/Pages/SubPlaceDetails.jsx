      ...
      <div className="bg-[#eff6ff]">
        <div className="max-w-[960px] mx-auto px-4">
          <Card className=" overflow-hidden rounded-none ">
            ...
            <div className="">
              <div className="max-w-4xl mx-auto p-3  grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Description Section */}
                <div className="">
                  <div>
                  ...
                  <div className="mt-6">
                    ...
                    <ul className="grid grid-cols-2 gap-3 mt-3 text-[#6E6E6E]">
                      <li className="flex items-center gap-2">
        ...
        <div className="bg-white w-full p-5 border-t-2 border-zinc-200">
          <div className="max-w-[960px] mx-auto px-4 flex justify-end items-center gap-5">
            ...
            <Link to={"select-date"}>
              <Button className="bg-darkBlue hover:bg-blue text-white rounded-full px-16 py-7 text-[1rem]">Set Duration Rent</Button>
            </Link>
          </div>
        </div>
      </div>
